...
import me.studygroup.study.modules.account.UserAccount;
...
public class Study {
    ...
    private LocalDateTime recruitingUpdatedDataTime;
    ...
    public boolean canUpdateRecruiting() {
        return this.published && this.recruitingUpdatedDataTime == null || this.recruitingUpdatedDataTime.isBefore(LocalDateTime.now().minusHours(1));
    }

    public void startRecruit() {
        if(canUpdateRecruiting()){
            this.recruiting = true;
            this.recruitingUpdatedDataTime = LocalDateTime.now();
        }else{
